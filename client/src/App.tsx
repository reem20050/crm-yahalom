  ...
  return (
    <div className="animate-fade-in p-4 lg:p-8 max-w-[1600px] space-y-6">
      <div className="space-y-2">
        <div className="animate-pulse bg-gray-200/70 rounded-lg h-8 w-48" />
        <div className="animate-pulse bg-gray-200/70 rounded-lg h-4 w-32" />
      </div>
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="bg-white rounded-2xl shadow-card p-6">
            <div className="animate-pulse bg-gray-200/70 rounded-xl w-10 h-10" />
            <div className="animate-pulse bg-gray-200/70 rounded-lg h-8 w-24 mt-3" />
            <div className="animate-pulse bg-gray-200/70 rounded-lg h-4 w-16 mt-1.5" />
          </div>
        ))}
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        {Array.from({ length: 2 }).map((_, i) => (
          <div key={i} className="bg-white rounded-2xl shadow-card p-6 space-y-3">
            <div className="animate-pulse bg-gray-200/70 rounded-lg h-5 w-32" />
            <div className="animate-pulse bg-gray-200/70 rounded-lg h-4 w-full" />
            <div className="animate-pulse bg-gray-200/70 rounded-lg h-4 w-[85%]" />
            <div className="animate-pulse bg-gray-200/70 rounded-lg h-4 w-[60%]" />
          </div>
        ))}
      </div>
    </div>
