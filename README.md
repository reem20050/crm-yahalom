...
> **מסך Priority** (`/priority`) מציג נתוני הנהלת-חשבונות מ-Priority ERP.
> הגדרה, משתני סביבה ונוהל רענון: [`docs/PRIORITY-INTEGRATION.md`](docs/PRIORITY-INTEGRATION.md)
>
> ⚠️ **קוד השרת הנפרס הוא `server/`**, לא `src/` בשורש. השניים התפצלו.
